...
## ✨ Key Features
- JWT User Authentication – Secure login and registration with email verification and forgot password flows
- Create, edit, and delete articles
- Image support for posts and profiles using cloudinary
